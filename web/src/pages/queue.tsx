			...
			{stats && (
				<div class="card card-section">
					<div class="queue-stats">
						...
						<div class="queue-stat-item">
							<span class="queue-stat-count queue-stat-failed">
								{stats.failed}
							</span>
					...
					<div class="dialog">
						...
						<div class="dialog-body">
							<dl class="job-detail">
								...
								<dd>
									<code>{selectedJob.type}</code>
								</dd>
								<dt>{t("my.queue.status")}</dt>
								<dd>
									<span class={`badge badge-${selectedJob.status}`}>
										{selectedJob.status}
									</span>
								</dd>
								...
								<dd>
									<pre class="job-detail-payload">{selectedJob.payload}</pre>
								</dd>
							</dl>
						</div>
